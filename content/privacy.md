...
### 1. Our Philosophy
We believe that your data belongs to you. Our applications are designed to be "pass-through" tools. We do not operate a cloud backend, we do not use tracking pixels, and we do not monetize your personal information. If we ever decide to change our "zero-data" stance (spoiler: we won't), we will update this page and provide a notification within the apps.
...
* **No Personal Information:** We do not require account creation on our end, email registration, or any personal identifying information (PII) to use our Services.
...
* **App Stores:** Platforms like the Google Play Store and Apple App Store manage app installation and In-App Purchases (IAP). They may collect data as governed by their respective privacy policies.
* **RetroAchievements API:** RetroStats communicates directly with RetroAchievements.org. Your use of this feature is subject to the [RetroAchievements Legal & Terms](https://retroachievements.org/terms).
* **No Analytics or Tracking:** We do not use third-party telemetry, advertising IDs, crash reporting services, or analytics frameworks (such as Firebase Analytics or Mixpanel) that phone home to us.

### 5. Data Security
Because your data remains on your physical device, local network, or self-hosted server, the security of your information relies primarily on your own infrastructure and device security. We recommend using strong device passwords, keeping your firmware updated, and ensuring proper SSL/TLS encryption on any self-hosted servers.
